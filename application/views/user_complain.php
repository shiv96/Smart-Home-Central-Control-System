            ...
            if ($fetch_data->num_rows() > 0) {
                foreach ($fetch_data->result() as $u) {
                    ...
                    <div class="w3-bar-block">
                        ...
                        <a href="<?php echo base_url('userpanel/user_devices/' . $u->name) ?>" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  DEVICES</a>
                        ...
                        <a href="<?php echo base_url('userpanel/chat_panel_view/'. $u->name)?>" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  LIVE CHAT</a>
                    </div>
                    <?php
                }
            }
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-col m7">
                            ...
                            if ($fetch_data->num_rows() > 0) {
                                foreach ($fetch_data->result() as $u) {
                                    ?>  
                                    <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="<?php echo base_url('userpanel/user_complain/' . $u->name) ?>"  method="post">
