                ...
                if ($fetch_data->num_rows() > 0) {
                    foreach ($fetch_data->result() as $u) {
                        ...
                        <div class="wrapper">
                            ...
                            <br>
                            <br>
                             <a href="http://localhost/instamojo/bill_pay.php"><button class="button button1">PAY BILL NOW</button></a>
                             <a href="http://localhost/instamojo/index.php"><button class="button button1">LOOK FOR ANOTHER PLAN</button></a>
                        </div>
