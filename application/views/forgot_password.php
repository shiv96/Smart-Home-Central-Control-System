...
<html lang="en">
    ...
    <body class="app flex-row align-items-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <a href="<?php echo base_url(); ?>"> <img style="width: 250px;padding-bottom: 20px;" src="<?php echo WEBSITE_LOGO_IMAGE; ?>" alt="Logit"></a>
                    ...
                    <div class="card p-4">
                        <div class="card-group mb-0">
                            ...
                            <div class="col-12 text-right">
                                <a href="<?php echo base_url('login') ?>" class="btn btn-link px-0">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer">
            <div class="ml-auto"><span class="tt-footer__copyright developed">Designed and Developed<i class="fa fa-heart" style="color: #cf2027;" aria-hidden="true"></i>by<a href="http://www.vethics.com/" target="_blank"><img src="<?php echo UPLOAD_URL_PATH. 'vethics-header-logo_blue.svg'; ?>" alt="vethics" /></a></span></div>
        </div>
        <style>
            .footer {
                position: fixed;
